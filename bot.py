...
#server_info
server_name = 'Island City Roleplay©'
application_team = 'Island City Application Team'
...
class abot(commands.Bot):
    ...
    async def on_ready(self):
        ...
        while True:
            ...
            await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name='Island City Roleplay'))
